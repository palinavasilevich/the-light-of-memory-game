...
export const story: SceneType[] = [
  ...
  // ===== CHAPTER 1 =====
  {
    groupId: "chapter1",
    id: "chapter1_1",
    backgroundImg: images.firstChapter.castle,
    text: "Ты просыпаешься на холодном полу...",
    sound: sounds.firstChapter.wind,
    storyteller: { name: "Storyteller" },
  },
  {
    groupId: "chapter1",
  ...
  },
  {
    ...
    sound: sounds.firstChapter.mirrorBreaking,
    notSoundLoop: true,
    storyteller: { name: "Storyteller" },
    showAvailableActions: true,
    nextSceneId: "chapter1_19_1",
...

  {
    ...
    id: "chapter1_19_2",
    backgroundImg: images.firstChapter.door,
    text: `Слова <i>"ZUM SPEICHER"</i> застряли в твоей голове, будто ждут разгадки.`,
    sound: sounds.firstChapter.wind,
    storyteller: { name: "Storyteller" },
  },

  {
    ...
    id: "chapter1_19",
    backgroundImg: images.firstChapter.door,
    text: `Перед тобой — старая дверь, а за ней, кажется, скрыты ответы.`,
    sound: sounds.firstChapter.wind,
    storyteller: { name: "Storyteller" },
  },

  {
    ...
    id: "chapter1_19",
    backgroundImg: images.firstChapter.door,
    text: `Ты делаешь глубокий вдох и решаешься войти внутрь.`, // ??? EDIT
    sound: sounds.firstChapter.wind,
    storyteller: { name: "Storyteller" },
  ...
  // ===== CHAPTER 2 =====
  {
    ...
    sound: sounds.secondChapter.books,
    storyteller: { name: "Storyteller" },
  },
  {
    groupId: "chapter2",
...

  {
    groupId: "chapter2",
    id: "chapter2_13",
    backgroundImg: images.secondChapter.letterClose,
    sound: sounds.secondChapter.books,
  ...
  },
  {
    groupId: "chapter_3",
    id: "chapter3_11",
    backgroundImg: images.thirdChapter.lastLine,
    sound: sounds.paper,
  ...
  // --- Зеркала ---
  {
    groupId: "chapter_4",
    id: "chapter_4_7",
    backgroundImg: images.fourthChapter.mirror,
    sound: sounds.flash,
  ...
  {
    groupId: "images.epilogue",
    id: "images.epilogue_1",
